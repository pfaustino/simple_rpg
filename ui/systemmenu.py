...
class SystemMenu:
    def __init__(self, screen_width, screen_height):
        ...
        self.menu_width = 300
        self.menu_height = len(self.options) * 50 + 80  # Reduced padding for better balance
        ...
        # Calculate option positions - start lower to accommodate title
        self.option_rects = []
    ...
    def draw(self, screen):
        ...
        # Draw options - start lower to match the new option_rects positions
